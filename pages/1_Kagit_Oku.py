...
with col_sol:
    ...
    ogretmen_promptu = st.text_area("", height=150, placeholder="Değerlendirme sırasında yapay zekanın göz önünde bulundurmasını istediklerinizi buraya yazabilirsiniz")
